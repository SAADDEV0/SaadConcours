// Blocks brute-forcing /api/admin/login — Node-only (uses lib/redis.js), so
...
// cf-connecting-ip d'abord : Cloudflare le pose lui-même et un client ne peut
// pas le falsifier. La première entrée de x-forwarded-for, elle, est celle
// que le client a envoyée — la lire en premier laissait un attaquant changer
// d'« adresse » à chaque tentative et contourner la limite de 5 essais.
