...
export const BAC_NIVEAUX = [
  {
    code: "1bac",
    label: "1ère Bac",
    // Masquée le 2026-09-24 (demande AdSense) : aucun chapitre n'est rédigé,
    // et ses 172 pages « en préparation » / « Bientôt » sont exactement ce que
    // la relecture sanctionne comme site en construction. Un niveau non
    // disponible ne génère aucune page (niveau, matières, chapitres) et
    // n'apparaît nulle part. Repasser à true quand ses chapitres seront écrits.
    available: false,
...
// Matières des niveaux publiés — ce que le site public génère. BAC_MATIERES
// garde tout le programme pour l'admin, qui peut rédiger un niveau masqué.
export const BAC_MATIERES_PUBLIEES = BAC_MATIERES.filter((m) => bacNiveauInfo(m.niveau)?.available);
