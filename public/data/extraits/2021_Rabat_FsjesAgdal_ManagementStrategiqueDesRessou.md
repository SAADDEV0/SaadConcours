**Exemple Concours Master Management Stratégique des Ressources Humaines (MSRH) 2021-2022 — FSJES Agdal**

*Répondre aux questions suivantes en cochant la ou les bonnes réponses.*

**1. L'objectif du management stratégique consiste à :**
...
a. à la description de la fonction
c. au type de collaborateur recherché

**3. Pour bien embaucher, il faut notamment :**
c. retenir les meilleurs employés
e. toutes ces réponses
b. sélectionner tous les candidats possibles
a. penser au futur immédiat
d. rester neutre

**4. Quels sont les différents modes de recrutement ?**
...
c. ses ambitions
b. ses amitiés conservées dans les postes précédents
d. ses réussites et performances
a. ses défis ou ses problèmes
e. toutes ces réponses
...
d. de questionner sur le parcours
a. de laisser évoquer le parcours professionnel
b. de briser la glace
e. toutes ces réponses
c. la rencontre binôme
...
a. Primes annuelles
b. Primes mensuelles
d. Les plans d'actionnariat
c. Les stocks options

**23. La prime d'ancienneté est destinée à rémunérer la fidélité à l'entreprise. Elle est calculée sur :**
d. Dernier salaire net perçu, multiplié par un taux
e. réponse (a) et réponse (d)
b. les heures supplémentaires, multiplié par un taux
c. Le nombre d'années d'ancienneté, multiplié par un taux
a. salaire de base + les heures supplémentaires, multiplié par un taux
...
**26. Les structures traditionnelles se caractérisent par :**
b) Cloisonnement de postes de travail
f) Communication facilitée entre les niveaux hiérarchiques
c) Décentralisation du pouvoir de décision
g) Aucune de ces réponses
d) Participation démocratique à la prise de décision
a) Flexibilité
e) Grande exigence en personnel

**27. Dans le cas d'un CDI, le contrat de travail est :**
a. facultatif, sauf si votre convention collective le prévoit
b. toujours obligatoire
c. obligatoire si le secteur n'a de convention collective
d. inutile si la convention collective décrit les obligations de chacun
e. réponse (b) et (c)

**28. Dans un contrat de CDI, il est obligatoire de mentionner :**
f. aucune de ces réponses
d. la durée de la mission
e. réponse (a) et (d)
a. le lieu de travail
b. un motif d'embauche
c. l'âge de l'employé

**31. La formation des ressources humaines :**
a. permet d'optimiser le transfert des apprentissages en milieu de travail
b. s'inscrit dans une perspective prévisionnelle de l'évolution professionnelle
c. agit sur les savoirs, les savoir-faire et les comportements des employés dans le but que ceux-ci correspondent aux besoins de l'entreprise
d. Toutes ces réponses
...
**33. Quel est le contenu d'un plan de formation ?**
b) contenus des formations
e) perspective de reclassement du personnel
f) réponses (a), (b) et (c)
...
b. ne comprend pas assez de très jeunes et de vieux ; les jeunes qui sont majoritaires, constituent une source d'innovation, les vieux n'étant pas nombreux
c. est harmonieuse, et traduit certainement une stratégie de recrutement régulière et une gestion des parcours professionnels
d. est composée d'une grande majorité de personnes âgées, et une petite minorité des jeunes
e. est composée d'une variation de personnes âgées et des moins âgées
a. ne prend pas en considération les tranches d'âges
...
e. Aucune de ces réponses
a. Une forme particulière de diversification dans la filière
d. Une forme de diversification non liée
c. Une forme de diversification conglomérale
b. Une forme particulière de spécialisation
...
b. D'un ensemble d'actions émergentes
c. Des routines, processus et activités quotidiennes de l'entreprise
e. Aucune de ces réponses
a. D'un processus rationnel et volontaire d'élaboration et de déploiement de la stratégie
d. De l'évolution générale de l'environnement de l'entreprise

**44. Lequel des éléments suivants ne peut pas figurer sur un bilan social :**
a) formation
e) toutes ces réponses sauf (c)
f) aucune de ces réponses
b) absentéisme
c) rémunérations individuelles
d) conflits de la période écoulée

**45. Le bilan social est un outil :**
d) réponse (b) et (c)
...
c) de gestion de la GRH

**46. Le bilan social est obligatoire pour les entreprises de plus de :**
d) 500 Salariés
c) 300 Salariés
a) 150 Salariés
b) 200 salariés
e) toutes les entreprises

**47. L'efficacité sociale :**
b) Elle mesure le degré d'atteinte des objectifs sociaux ou socio-économiques
d) Elle est appréciée à travers le rendement et la productivité au travail
c) C'est le rapport entre la production obtenue et le temps consacré à son obtention
a) C'est le rapport entre les résultats obtenus et les moyens mis en œuvre pour les obtenir

**48. Le climat social dépend :**
b) des relations sociales instaurées dans l'entreprise
e) toutes ces réponses (a), (b) et (c)
a) de la température à l'intérieur de l'entreprise
c) des résultats de l'entreprise
d) réponse (a) et (b)

**49. Parmi ces indicateurs, quels sont ceux qui permettent d'évaluer le climat social ?**
c) Le nombre de conflits
d) Le taux de rebut
a) Le taux d'absentéisme
e) réponses (a), (b) et (c)
b) Le taux de réclamation clients

**50. Le dialogue social, c'est :**
...
**51. Deux salariés sont en désaccord sur une procédure à suivre. Il s'agit d'un conflit :**
c) hiérarchique
e) réponses (a) et (c)
b) de valeurs
d) interpersonnel
...
**52. Les observatoires sociaux sont :**
a) des salariés travaillant pour un syndicat
b) des salariés représentant leurs collègues dans les relations de travail
c) des voyageurs représentants placiers d'un genre particulier
d) réponses (a) et (b)

**53. Les représentants syndicaux sont :**
d) Toutes ces réponses
a) des salariés travaillant pour un syndicat
c) des voyageurs représentants placiers d'un genre particulier
b) des salariés représentant leurs collègues dans les relations de travail
...
c. Faire apparaître les clients mauvais payeurs
